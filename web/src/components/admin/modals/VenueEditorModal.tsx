            ...
            <div className="space-y-4">
                <div className="space-y-1">
                    ...
                    <input 
                        ...
                        className="w-full bg-stone-50 dark:bg-stone-950 border border-stone-100 dark:border-stone-800 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-coffee/50"
                    />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                    <div className="flex justify-between items-center mb-1">
                        ...
                        <button 
                            ...
                            className="text-[10px] font-black uppercase text-coffee hover:underline flex items-center space-x-1"
                        >
                            <MapPin size={10} />
                ...
                <button 
                    ...
                    className="w-full bg-coffee text-white py-4 rounded-3xl font-black shadow-xl active:scale-95 transition-transform disabled:opacity-50 flex items-center justify-center space-x-2"
                >
